...
>
    ...
    <xsl:variable name="optionConstructor" select="not($noConstructor='true')"/>
...
// ------------------------------------------------------------------------------
 ...
 --><xsl:call-template name="WriteUsings">
    ...
    <xsl:template match="FileDescriptorSet">
        <xsl:if test="$help='true'">
            <xsl:message terminate="yes">
                ...
                "noConstructor" - no constructors are generated
            </xsl:message>
        </xsl:if>
        ...
        <xsl:if test="$optionDetectMissing">
            // Option: missing-value detection (*Specified/ShouldSerialize*/Reset*) enabled
        </xsl:if>
        <xsl:if test="not($optionFullFramework)">
            // Option: light framework (CF/Silverlight) enabled
        </xsl:if>
        <xsl:if test="not($optionConstructor)">
            // Option: noConstructor enabled
        </xsl:if>
        <xsl:if test="$optionFixCase">
    ...
    <xsl:template match="DescriptorProto">
        ...
        <xsl:if test="$optionDataContract">
            [global::System.Runtime.Serialization.DataContract(Name=@"<xsl:value-of select="name"/>")]
        </xsl:if><xsl:if test="$optionXml">
            [global::System.Xml.Serialization.XmlType(TypeName=@"<xsl:value-of select="name"/>")]
        </xsl:if><!--
  ...
  --><xsl:if test="$optionPreObservable">, global::System.ComponentModel.INotifyPropertyChanging</xsl:if>
    ...
    <xsl:template match="EnumValueDescriptorProto">
      ...
      --><xsl:if test="$optionDataContract">
            [global::System.Runtime.Serialization.EnumMember(Value=@"<xsl:value-of select="name"/>")]
        </xsl:if><!--
      --><xsl:if test="$optionXml">
            [global::System.Xml.Serialization.XmlEnum(@"<xsl:value-of select="name"/>")]
        </xsl:if><!--
      --><xsl:text disable-output-escaping="yes">
    ...
    <xsl:template match="FieldDescriptorProto" mode="field">
        ...
        <xsl:call-template name="escapeKeyword">
            <xsl:with-param name="value">
                <xsl:choose>
                    <xsl:when test="not(key('fieldNames',concat('_',$field)))">
                        <xsl:value-of select="concat('_',$field)"/>
                    </xsl:when>
                    <xsl:when test="not(key('fieldNames',concat($field,'Field')))">
    ...
    <xsl:template name="escapeKeyword">
        ...
        <xsl:if test="contains($keywords,concat('|',$value,'|'))">@</xsl:if>
        <xsl:value-of select="$value"/>
    </xsl:template>
    ...
    <xsl:template match="FieldDescriptorProto" mode="type">
        <xsl:choose>
            ...
            <xsl:when test="type='TYPE_GROUP' or type='TYPE_MESSAGE' or type='TYPE_ENUM'">
    ...
    <xsl:template match="FieldDescriptorProto[default_value]" mode="defaultValue">
        <xsl:choose>
            <xsl:when test="type='TYPE_STRING'">
                @"<xsl:value-of select="default_value"/>"
            </xsl:when>
            <xsl:when test="type='TYPE_ENUM'">
                <xsl:apply-templates select="." mode="type"/>.<xsl:call-template name="pascal">
            ...
            <xsl:otherwise>
                (<xsl:apply-templates select="." mode="type"/>)<xsl:value-of select="default_value"/>
            </xsl:otherwise>
        </xsl:choose>
    </xsl:template>
  ...
  -->
    <xsl:template name="GetFirstEnumValue">
        ...
        <xsl:for-each select="//EnumDescriptorProto">
            <xsl:variable name="fullName">
                <xsl:for-each select="ancestor::FileDescriptorProto[package!='']">
                    .<xsl:value-of select="package"/>
                </xsl:for-each>
                <xsl:for-each select="ancestor::DescriptorProto">
                    .<xsl:value-of select="name"/>
                </xsl:for-each>
                <xsl:value-of select="'.'"/>
                <xsl:call-template name="pascal"/>
            </xsl:variable>
            <xsl:if test="$fullName=$hunt">
                <xsl:value-of select="(value/EnumValueDescriptorProto)[1]/name"/>
            </xsl:if>
        </xsl:for-each>
    </xsl:template>
    ...
    <xsl:template match="FieldDescriptorProto[not(default_value)]" mode="defaultValue">
        <xsl:choose>
            ...
            <xsl:when test="type='TYPE_ENUM'">
                <xsl:apply-templates select="." mode="type"/>.<xsl:call-template name="GetFirstEnumValue"/>
            </xsl:when>
            <xsl:otherwise>
                default(<xsl:apply-templates select="." mode="type"/>)
            </xsl:otherwise>
        </xsl:choose>
    </xsl:template>
  ...
  -->
    ...
    <xsl:template match="FieldDescriptorProto[label='LABEL_OPTIONAL' or not(label)]">
        ...
        <xsl:variable name="defaultValue">
            <xsl:apply-templates select="." mode="defaultValue"/>
        </xsl:variable>
        <xsl:variable name="field">
        ...
        <xsl:variable name="fieldType">
            ...
            <xsl:if test="$specified and $primitiveType='struct'">?</xsl:if>
        </xsl:variable>
        private <xsl:value-of select="concat($fieldType,' ',$field)"/><xsl:if test="not($specified)">
    ...
    --><xsl:if test="not($specified)">
            [global::System.ComponentModel.DefaultValue(<xsl:value-of select="$defaultValue"/>)]
        </xsl:if><!--
    --><xsl:if test="$optionXml">
    ...
    <xsl:template match="FieldDescriptorProto[label='LABEL_REQUIRED']">
        ...
        private <xsl:value-of select="concat($type, ' ', $field)"/><xsl:if test="$defaultValue">
            = <xsl:value-of select="$defaultValue"/>
        </xsl:if>;
    ...
    <xsl:template name="WriteGetSet">
        ...
        {
        get { return <xsl:value-of select="$field"/> <xsl:if test="$specified">
            ?? <xsl:value-of select="$defaultValue"/>
        </xsl:if>; }
        set { <xsl:if test="$optionPartialMethods">
            On<xsl:value-of select="$nameNoKeyword"/>Changing(value);
        </xsl:if><xsl:if test="$optionPreObservable">
            OnPropertyChanging(@"<xsl:value-of select="$nameNoKeyword"/>");
        </xsl:if><xsl:value-of select="$field"/> = value; <xsl:if test="$optionObservable">
            OnPropertyChanged(@"<xsl:value-of select="$nameNoKeyword"/>");
        </xsl:if><xsl:if test="$optionPartialMethods">
            On<xsl:value-of select="$nameNoKeyword"/>Changed();
        </xsl:if>}
        }<xsl:if test="$optionPartialMethods">
            partial void On<xsl:value-of select="$nameNoKeyword"/>Changing(<xsl:value-of select="$propType"/> value);
            partial void On<xsl:value-of select="$nameNoKeyword"/>Changed();
        </xsl:if><xsl:if test="$specified">
    ...
    <xsl:template match="ServiceDescriptorProto">
        <xsl:if test="($optionClientProxy or $optionDataContract)">
            [global::System.ServiceModel.ServiceContract(Name = @"<xsl:value-of select="name"/>")]
        </xsl:if>
        public interface I<xsl:call-template name="pascal"/>
        {
    ...
    <xsl:template match="MethodDescriptorProto">
        <xsl:if test="($optionClientProxy or $optionDataContract)">
            ...
            <xsl:if test="$optionFullFramework">
                [global::ProtoBuf.ServiceModel.ProtoBehavior]
            </xsl:if>
        </xsl:if>
        <xsl:apply-templates select="output_type"/><xsl:text xml:space="preserve"> </xsl:text><xsl:call-template name="pascal"/>(<xsl:apply-templates select="input_type"/> request);
        <xsl:if test="$optionAsynchronous and ($optionClientProxy or $optionDataContract)">
            ...
            global::System.IAsyncResult Begin<xsl:call-template name="pascal"/>(<xsl:apply-templates select="input_type"/> request, global::System.AsyncCallback callback, object state);
            <xsl:apply-templates select="output_type"/> End<xsl:call-template name="pascal"/>(global::System.IAsyncResult ar);
        </xsl:if>
    </xsl:template>
    ...
    <xsl:template match="MethodDescriptorProto" mode="CompleteEvent">
        <xsl:if test="$optionAsynchronous and $optionDataContract">
            ...
            public partial class <xsl:call-template name="pascal"/>CompletedEventArgs : global::System.ComponentModel.AsyncCompletedEventArgs
            {
            private readonly object[] results;

            public <xsl:call-template name="pascal"/>CompletedEventArgs(object[] results, global::System.Exception exception, bool cancelled, object userState)
    ...
    <xsl:template match="ServiceDescriptorProto" mode="clientProxy">
        <xsl:if test="$optionAsynchronous and $optionDataContract and $optionClientProxy">
            ...
            public partial class <xsl:call-template name="pascal"/>Client : global::System.ServiceModel.ClientBase&lt;I<xsl:call-template name="pascal"/>&gt;, I<xsl:call-template name="pascal"/>
            {
            public <xsl:call-template name="pascal"/>Client()
            {}
            public <xsl:call-template name="pascal"/>Client(string endpointConfigurationName)
            : base(endpointConfigurationName)
            {}
            public <xsl:call-template name="pascal"/>Client(string endpointConfigurationName, string remoteAddress)
            : base(endpointConfigurationName, remoteAddress)
            {}
            public <xsl:call-template name="pascal"/>Client(string endpointConfigurationName, global::System.ServiceModel.EndpointAddress remoteAddress)
            : base(endpointConfigurationName, remoteAddress)
            {}
            public <xsl:call-template name="pascal"/>Client(global::System.ServiceModel.Channels.Binding binding, global::System.ServiceModel.EndpointAddress remoteAddress)
    ...
    <xsl:template match="MethodDescriptorProto" mode="clientProxy">
        <xsl:if test="$optionAsynchronous and $optionDataContract and $optionClientProxy">
            private BeginOperationDelegate onBegin<xsl:call-template name="pascal"/>Delegate;
            private EndOperationDelegate onEnd<xsl:call-template name="pascal"/>Delegate;
            private global::System.Threading.SendOrPostCallback on<xsl:call-template name="pascal"/>CompletedDelegate;

            public event global::System.EventHandler&lt;<xsl:call-template name="pascal"/>CompletedEventArgs&gt; <xsl:call-template name="pascal"/>Completed;

            public <xsl:apply-templates select="output_type"/><xsl:text xml:space="preserve"> </xsl:text><xsl:call-template name="pascal"/>(<xsl:apply-templates select="input_type"/> request)
            {
            return base.Channel.<xsl:call-template name="pascal"/>(request);
            }

            [global::System.ComponentModel.EditorBrowsableAttribute(global::System.ComponentModel.EditorBrowsableState.Advanced)]
            public global::System.IAsyncResult Begin<xsl:call-template name="pascal"/>(<xsl:apply-templates select="input_type"/> request, global::System.AsyncCallback callback, object asyncState)
            {
            return base.Channel.Begin<xsl:call-template name="pascal"/>(request, callback, asyncState);
            }

            [global::System.ComponentModel.EditorBrowsableAttribute(global::System.ComponentModel.EditorBrowsableState.Advanced)]
            public <xsl:apply-templates select="output_type"/> End<xsl:call-template name="pascal"/>(global::System.IAsyncResult result)
            {
            return base.Channel.End<xsl:call-template name="pascal"/>(result);
            }

            private global::System.IAsyncResult OnBegin<xsl:call-template name="pascal"/>(object[] inValues, global::System.AsyncCallback callback, object asyncState)
            {
            <xsl:apply-templates select="input_type"/> request = ((<xsl:apply-templates select="input_type"/>)(inValues[0]));
            return this.Begin<xsl:call-template name="pascal"/>(request, callback, asyncState);
            }

            private object[] OnEnd<xsl:call-template name="pascal"/>(global::System.IAsyncResult result)
            {
            <xsl:apply-templates select="output_type"/> retVal = this.End<xsl:call-template name="pascal"/>(result);
            return new object[] {
            retVal};
            }

            private void On<xsl:call-template name="pascal"/>Completed(object state)
            {
            if ((this.<xsl:call-template name="pascal"/>Completed != null))
            {
            InvokeAsyncCompletedEventArgs e = ((InvokeAsyncCompletedEventArgs)(state));
            this.<xsl:call-template name="pascal"/>Completed(this, new <xsl:call-template name="pascal"/>CompletedEventArgs(e.Results, e.Error, e.Cancelled, e.UserState));
            }
            }

            public void <xsl:call-template name="pascal"/>Async(<xsl:apply-templates select="input_type"/> request)
            {
            this.<xsl:call-template name="pascal"/>Async(request, null);
            }

            public void <xsl:call-template name="pascal"/>Async(<xsl:apply-templates select="input_type"/> request, object userState)
            {
            if ((this.onBegin<xsl:call-template name="pascal"/>Delegate == null))
            {
            this.onBegin<xsl:call-template name="pascal"/>Delegate = new BeginOperationDelegate(this.OnBegin<xsl:call-template name="pascal"/>);
            }
            if ((this.onEnd<xsl:call-template name="pascal"/>Delegate == null))
            {
            this.onEnd<xsl:call-template name="pascal"/>Delegate = new EndOperationDelegate(this.OnEnd<xsl:call-template name="pascal"/>);
            }
            if ((this.on<xsl:call-template name="pascal"/>CompletedDelegate == null))
            {
            this.on<xsl:call-template name="pascal"/>CompletedDelegate = new global::System.Threading.SendOrPostCallback(this.On<xsl:call-template name="pascal"/>Completed);
            }
            base.InvokeAsync(this.onBegin<xsl:call-template name="pascal"/>Delegate, new object[] {
            request}, this.onEnd<xsl:call-template name="pascal"/>Delegate, this.on<xsl:call-template name="pascal"/>CompletedDelegate, userState);
            }
        </xsl:if>
    </xsl:template>
</xsl:stylesheet>
